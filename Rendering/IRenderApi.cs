...
public interface IRenderApi
{
    ...
    void DrawImage(string imagePath, Rect rect, Color multiplicativeColor, bool loadAsync = false);
    void DrawImage(RawImageData image, Rect rect, Color multiplicativeColor);
    void DrawImage(EncodedImageData image, Rect rect, Color multiplicativeColor);
